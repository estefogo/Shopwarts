...
public class MySQL {
   ...
   //atributos de conexão com o banco
    ...
    private String nomeDoBanco = "Shopwarts";
    private String usuario = "root";
    private String senha = "9;:&iFh5+Zt(xw#";
    ...
    public void conectaBanco(){
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mariadb://" + servidor + "/" + nomeDoBanco, usuario, senha);
            //conn = DriverManager.getConnection("jdbc:mariadb://localhost3306/cadastra", "root", "intelbras");
