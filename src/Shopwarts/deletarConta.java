...
public class deletarConta extends javax.swing.JFrame {
   ...
   MySQL conectar = new MySQL(); //acessar os métodos de conexao com o banco
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/deletar-usuario.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deletarConta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deletarConta().setVisible(true);
            }
        });
    }
